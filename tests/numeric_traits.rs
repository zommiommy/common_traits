...
#[test]
fn test_ilog2_ceil_small_values() {
...
#[test]
#[should_panic]
fn test_ilog2_ceil_zero_panics() {
    // Documented: panics for `self <= 0`.
    let _ = <u32 as UnsignedInt>::ilog2_ceil(0);
}

#[test]
fn test_div_ceil_no_overflow_near_max() {
...
#[test]
#[should_panic]
fn test_clamp_panics_on_min_gt_max() {
    // Documented contract: panics if `min > max`.
    let _ = <u8 as Number>::clamp(5, 10, 0);
}

#[test]
fn test_extract_bitfield_keeps_sign_bit() {
...
#[test]
fn test_abs_diff_returns_unsigned_exact() {
...
#[test]
fn test_unsigned_sibling_types_are_coherent() {
...
#[test]
#[should_panic]
fn test_pow_panics_on_exponent_over_u32() {
...
#[test]
#[should_panic]
fn test_saturating_pow_panics_on_exponent_over_u32() {
...
#[cfg(feature = "half")]
#[test]
fn test_half_mul_add_is_single_rounding() {
    use half::f16;
