...
fn test_u8_div(b: &mut Bencher) {
    ...
    let d = rng.random_range(2..<u8>::MAX) as u8;
    b.iter(|| {
        let a = rng.random_range(0..<u8>::MAX) as u8;
...
fn test_u16_div(b: &mut Bencher) {
    let mut rng = SmallRng::seed_from_u64(0);
    let d = rng.random_range(2..<u16>::MAX) as u16;
    b.iter(|| {
        let a = rng.random_range(0..<u16>::MAX) as u16;
        black_box(a) / black_box(d)
    })
}
#[bench]
...
fn test_u32_div(b: &mut Bencher) {
    let mut rng = SmallRng::seed_from_u64(0);
    let d = rng.random_range(2..<u32>::MAX) as u32;
    b.iter(|| {
        let a = rng.random_range(0..<u32>::MAX) as u32;
        black_box(a) / black_box(d)
    })
}
#[bench]
...
fn test_u64_div(b: &mut Bencher) {
    let mut rng = SmallRng::seed_from_u64(0);
    let d = rng.random_range(2..<u64>::MAX) as u64;
    b.iter(|| {
        let a = rng.random_range(0..<u64>::MAX) as u64;
        black_box(a) / black_box(d)
    })
}
#[bench]
